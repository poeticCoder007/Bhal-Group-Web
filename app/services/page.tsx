        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              adherence to strict safety standards. Our experienced team has extensive experience working in operational
              facilities, minimizing disruptions while delivering quality results on time and within budget.
            </p>
          </div>
              ...
              <CardContent className="pt-0">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                  ...
                  <div className="flex items-start text-left">
                    <CheckCircle2 className="h-6 w-6 text-bhal-600 mt-1 mr-4 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-lg text-gray-900 mb-2">Manufacturing Facilities</h4>
                      <p className="text-gray-600">
                        Comprehensive construction services for various manufacturing and production facilities.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start text-left">
                    <CheckCircle2 className="h-6 w-6 text-bhal-600 mt-1 mr-4 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-lg text-gray-900 mb-2">Warehouses & Distribution Centers</h4>
                      <p className="text-gray-600">
